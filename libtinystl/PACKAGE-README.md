...
This package tracks upstream commit `c51bc42011eb4920df09408d996921547200e2fd`.
Upstream does not publish releases. Correctness fixes from the tinystl fork
maintained in `bx`/`bgfx` by _Branimir Karadzic_ are applied as `.orig`/`.patch`
files.
